...
use Drupal\Core\Url;
use Drupal\contact_entity\Entity\ContactEntityInterface;
...
class ContactEntityController extends ControllerBase implements ContainerInjectionInterface {
   ...
   *
   * @param \Drupal\contact_entity\Entity\ContactEntityInterface $contact_entity
  ...
  public function revisionOverview(ContactEntityInterface $contact_entity) {
    ...
    foreach (array_reverse($vids) as $vid) {
      /** @var \Drupal\contact_entity\ContactEntityInterface $revision */
